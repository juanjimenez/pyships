...
M, B, T = barchain_matrix_sp_all.Matriz_t_ini(cd,1)
...
for i in range(tam):
    ...
    M, B, T = barchain_matrix_sp_all.Matriz_t_3b(M ,B , T, cd, bi, bd, bc)
    j = bc.link
