...
pero cada barco solo se preocupa de comservar su propio rumbo....
pasa
remake: 29.05.2017
modificado para barcos pequeños: 01.06.2017
@author: juan
"""
#import barcosolo_nv
import usv
...
#cd5 = boom.cadena(100,np.array([10,10,1000]))
cd5 = boom.cadena(18,np.array([2,2,1000]))
cd5.L = 0.415
...
bi.pmax = 10.
bi.Ib = 0.85
bi.mua = 0. #caveat in the equations damping is bd.mua*bd.ls*bd.wb  
bi.mua2 = 9.7577 #caveat in the equations damping is bd.mua*bd.ls*bd.wb**2 
bi.mut2 = 2.226
bi.mut = 0.1
bi.mul2= 1.219
bi.mul = 0.01
...
bi.krd = [0.,0.,0.] #[1,5.,0.1]
bd.krd = [0.,0.,0.] #[1,5.,0.1]
...
#tamaño experimento
###############################################################################
tam = 20000000#0000 #aqui definimos de momento el tamaño del experimento...
step =200000#00000 #1000
...
#    bd.controlador(delta,c_rumbo,1.,1000,np.array([-d_surge,d_sway]))#(delta,0.,0.4,500,3)
    ...
    #print 'izq'
    bi.controlador(delta,c_rumbo,1.,1,np.array([d_surge,-d_sway]))#(delta,0.,0.4,500,3)    
    #print 'dcha'    
    bd.controlador(delta,c_rumbo,1.,1,np.array([-d_surge,d_sway]))#(delta,0.,0.4,500,3)
