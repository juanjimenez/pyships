...
#creamos los barcos
bi = barcosolo.barco(1) #,'timon')
bd = barcosolo.barco(2) #,'timon')
...
bi.setl = 1000 #valor de velocidad feedforward
bi.setw = 0
bi.ls = 5.
bi.mb = 350.
bi.pmax = 5000.
...
bd.setl = 1000 #valor de velocidad feedforward
bd.setw = 0
bd.ls = 5.
bd.mb = 350.
bd.pmax = 5000.
...
tam = 5000 #50000 #aqui definimos de momento el tamaño del experimento...
step = 100 #1000
...
for i in range(tam+1):
    ...
    M, B, T = barchain_matrix.Matriz_t_ini(cd5,0)
    M, B, T = barchain_matrix.Matriz_t(M, B, T, cd5,bi,bd)
